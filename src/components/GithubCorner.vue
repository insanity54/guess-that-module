<template>
  <a href="https://github.com/insanity54/guess-that-module" class="github-corner" aria-label="View source on GitHub"><svg width="80" height="80" viewBox="0 0 250 250" style="fill:#86cecb; color:#fff; position: absolute; top: 0; border: 0; right: 0;"
    aria-hidden="true">
